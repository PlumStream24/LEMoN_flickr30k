...
def main(bs, k, dist_type, compr_dataset_size_limit, skip_train, noise_type, noise_level):
...
if __name__ == "__main__":
    ...
    main(bs = bs, k = k, dist_type = dist_type, compr_dataset_size_limit = compr_dataset_size_limit, skip_train = skip_train, noise_type = noise_type, noise_level = noise_level)